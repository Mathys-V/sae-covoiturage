...
<head>
    ...
    <style>
        ...
        .avatar-overlay i { color: white; font-size: 2rem; }

        /* Styles Modale Signalement */
        .custom-textarea {
            background-color: #f8f9fa; border: 2px solid #e9ecef;
            border-radius: 12px; padding: 15px; font-size: 0.95rem;
            color: #333; resize: none; transition: all 0.3s ease; width: 100%;
        }
        .custom-textarea:focus {
            background-color: #ffffff; border-color: #8c52ff;
            box-shadow: 0 0 0 4px rgba(140, 82, 255, 0.15); outline: none;
        }
        .form-label-bold { font-weight: 700; color: #2c3e50; margin-bottom: 8px; display: block; }
        
        /* Style Lien Profil Public */
        .profile-link { text-decoration: none; color: inherit; transition: color 0.2s; }
        .profile-link:hover .fw-bold { color: #8c52ff; text-decoration: underline; }
    </style>
</head>
