...
<style>
    .autocomplete-wrapper { border: none !important; box-shadow: none !important; background: transparent !important; }
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-5">
                        ...
                        <div class="autocomplete-wrapper">
                            <input type="text" id="depart" name="depart" class="form-control rounded-pill py-2" 
                                   placeholder="Ex: Gare d'Amiens..." 
                                   value="{$recherche_precedente.depart}" required>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="date" name="date" class="form-control rounded-pill py-2" 
                               value="{$recherche_precedente.date}" required>
                    </div>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (warningText) {
            ...
            if (cookieConsent) {
                try { if (JSON.parse(decodeURIComponent(cookieConsent[1])).performance == 1) showWarning = false; } catch (e) {}
            }
            if (showWarning) warningText.classList.remove('d-none');
        }
    });
</script>
