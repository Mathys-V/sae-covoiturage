{* Inclusion de la feuille de style spécifique au pied de page *}
<link rel="stylesheet" href="/sae-covoiturage/public/assets/css/includes/style_footer.css">

<footer class="footer-custom py-4">
    <div class="container">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
            
            {* Section des liens utilitaires (Contact, Mentions légales...) *}
            ...
            {* Section identité visuelle (Logo + Copyright) *}
...
{* Inclusion du script Bootstrap (nécessaire pour la navbar, les modals, etc.) *}
