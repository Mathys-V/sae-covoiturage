...
<head>
    ...
    <link rel="stylesheet" href="/sae-covoiturage/public/assets/css/style_avis.css">
</head>
...
<body>
            ...
            <div class="content-box">
                ...
                <div id="view-cond">
                    ...
                    <div class="text-center mb-5">
                        <div class="display-4 fw-bold text-primary">{$moy_cond}<span class="fs-4 text-muted">/5</span>
                        </div>
                        <div class="text-warning fs-3 mb-2">
                            {section name=i loop=5}
                                {if $smarty.section.i.index < $moy_cond}<i class="bi bi-star-fill"></i>
                                        ...
                                        <div class="d-flex">
                                            <div class="me-3">
                                                {if !empty($avis.photo_profil)}
                                                    <img src="/sae-covoiturage/public/assets/uploads/{$avis.photo_profil}"
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="text-warning mb-2" style="font-size: 0.8rem;">
                                                    {section name=star loop=5}
                                                        {if $smarty.section.star.index < $avis.note}<i
                                                            class="bi bi-star-fill"></i>{else}<i class="bi bi-star"></i>
                                                        {/if}
                                                    {/section}
                                                </div>
                ...
                <div id="view-pass" style="display: none;">
                    ...
                    <div class="text-center mb-5">
                        <div class="display-4 fw-bold text-primary">{$moy_pass}<span class="fs-4 text-muted">/5</span>
                        </div>
                        <div class="text-warning fs-3 mb-2">
                            {section name=i loop=5}
                                {if $smarty.section.i.index < $moy_pass}<i class="bi bi-star-fill"></i>
                                {else}<i class="bi bi-star"></i>
                                {/if}
                            {/section}
                        </div>
    ...
    <script>
        function switchTab(type) {
            ...
            // 3. Afficher la vue demandée avec une petite animation d'opacité
            const targetView = document.getElementById('view-' + type);
            targetView.style.display = 'block';
            targetView.style.opacity = '0';

            // Petit délai pour permettre au navigateur de rendre le display:block avant de changer l'opacité
            setTimeout(() => {
